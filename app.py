...
kms = st.number_input("Kilometers Driven", min_value=0,
                      max_value=300000, step=1000)
age = st.number_input("Age of the Car (in years)",
                      min_value=0, max_value=25, step=1)
oprice = st.number_input("Original Price (Rs.)",
                         min_value=500000, max_value=5000000, step=10000)
